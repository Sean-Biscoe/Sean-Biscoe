...
| **[US Census Income Predictive Model](https://github.com/Sean-Biscoe/census-income-orange-analysis)** · [🔗 Live App](census-app-gq4dqnnappw7xv2ntyetq3w.streamlit.app)         | `Orange Data Mining`, `Welch's t-test`, `SHAP`, `Gradient Boosting` | End-to-end pipeline on **1.66M rows**. Evaluated 7 classifiers (Gradient Boosting **AUC: 0.879**) with SHAP + Welch’s t-test. |                                 
