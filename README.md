...
| **[US Census Income Predictive Model](https://github.com/Sean-Biscoe/census-income-orange-analysis)** · [🔗 Live App](https://census-app-gq4dqnnappw7xv2ntyetq3w.streamlit.app)         | `Orange Data Mining`, `Welch's t-test`, `SHAP`, `Gradient Boosting` | End-to-end pipeline on **1.66M rows**. Evaluated 7 classifiers (Gradient Boosting **AUC: 0.879**) with SHAP + Welch’s t-test. |                                 
| **[River Flow & Rainfall Pipeline](https://github.com/Sean-Biscoe/HydroForecast-MLP-River-Flow-Prediction-from-Scratch)**            | `Python`, `NumPy`, `Pandas`, `Time-Series`              | Data cleaning, PCHIP interpolation, and time-lagged feature engineering.                                                      |
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0A3641,50:0E6268,100:00A896&height=120&section=footer" width="100%" />
</div>
